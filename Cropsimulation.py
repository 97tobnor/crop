...
from manual_grow import*

class CropWindow(QMainWindow):
    """denna klassen bygger en main window för att se hur den växer."""
    #constructor
    def __init__(self):
    ...
    def create_view_crop_layout(self,crop_type):
        #this is the second layout of the program
    ...
    def instantiate_crop(self):
        ...
        self.stacked_layout.setCurrentIndex(1) #change the visible layout to the stacked one
